...
object MoviePlayer {
  ...
  sealed trait Track
  case object Pre extends Track
  case object Next extends Track

  private[this] def playAt(track: Track, tableView: TableView[Movie],
                           mediaView: MediaView, timeLabel: Label): Unit = {
  ...
  def playPre(tableView: TableView[Movie],
                            mediaView: MediaView, timeLabel: Label): Unit =
    playAt(Pre, tableView, mediaView, timeLabel)

  def playNext(tableView: TableView[Movie],
                             mediaView: MediaView, timeLabel: Label): Unit =
